...
funMain() {
    ...
    addFile "      cd ~ ;"
    addFile "    elif [[ \$1 == des ]] || [[ \$1 == Des ]]; then"
    addFile "      cd ~/Desktop ;"
    addFile "    elif [[ \$1 == doc ]] || [[ \$1 == Doc ]]; then"
    addFile "      cd ~/Documents ;"
    addFile "    elif [[ \$1 == dow ]] || [[ \$1 == Dow ]]; then"
    addFile "      cd ~/Downloads ;"
    addFile "    elif [[ \$1 == mov ]] || [[ \$1 == Mov ]]; then"
    addFile "      cd ~/Movies ;"
    addFile "    elif [[ \$1 == mus ]] || [[ \$1 == Mus ]]; then"
    addFile "      cd ~/Music ;"
    addFile "    elif [[ \$1 == pic ]] || [[ \$1 == Pic ]]; then"
    addFile "      cd ~/Pictures ;"
    addFile "    elif [[ \$1 == vid ]] || [[ \$1 == Vid ]]; then"
    addFile "      cd ~/Videos ;"
    addFile "    elif [[ \$1 == --help ]] || [[ \$1 == -help ]] || [[ \$1 == -h ]]; then"
    addFile "      echo \"p: move to parent directory\""
    addFile "      echo \"p [number]: move to parent [number]th directory\""
    addFile "      echo \"p p: output current directory\""
    addFile "      echo \"p b(-): move to previous directory\""
    addFile "      echo \"p r(/): move to root directory\""    
    addFile "      echo \"p h(~): move to home directory\""
    addFile "      echo \"p des: move to desktop directory\""
    addFile "      echo \"p doc: move to documents directory\""
    addFile "      echo \"p dow: move to downloads directory\""
    addFile "      echo \"p mov: move to movies directory\""
    addFile "      echo \"p mus: move to music directory\""
    addFile "      echo \"p pic: move to pictures directory\""
    addFile "      echo \"p vid: move to videos directory\""
    addFile "      echo \"p -h: output usage\""
    addFile "    else"
    addFile "      echo \"p: wrong usage\" ;"
    addFile "    fi"
    addFile "  else"
    addFile "    echo \"p: wrong usage\" ;"
    addFile "  fi"
