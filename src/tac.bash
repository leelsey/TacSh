...
# For Enviroments
admin () { sudo -i ; }
shrl () { echo "reloaded shell" && exec -l /bin/bash ; }
rlsh () {
...
#ll () { ls -l "$@" ; }
la () { ls -A "$@" ; }
ld () { ls -Cd .bash_history .bash_logout .bash_profile .bashrc .cache .config .local .mozilla .pki .var .vscode .vscode-oss "$@" ; }
lal () { ls -Al "$@" ; }
lla () { ls -al "$@" ; }
llo () { ls -alO "$@" ; }
lsf () { ls -F "$@" ; }
lld () { ls -ld .bash_history .bash_logout .bash_profile .bashrc .cache .config .local .mozilla .pki .var .vscode .vscode-oss "$@" ; }
...
his () { history "$@" ; }
cls () { clear ; }
clh () { history -c && exec /bin/bash -l; }
clha () { rm -f ~/.bash_history; rm -f ~/.node_repl_history; rm -f ~/.python_history; exec /bin/bash -l; }
shdn () { sudo shutdown "$@" ; }
