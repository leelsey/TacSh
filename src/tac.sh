...
# For Enviroments
admin () { sudo -i ; }
shrl () { echo "reloaded shell" && exec -l zsh ; }
...
ll () { ls -l "$@" ; }
la () { ls -A "$@" ; }
ld () { ls -Cd .DS_Store .git "$@" ; }
lal () { ls -Al "$@" ; }
lla () { ls -al "$@" ; }
llo () { ls -alO "$@" ; }
lsf () { ls -F "$@" ; }
lld () { ls -ld .DS_Store .git "$@" ; }
...
his () { history "$@" ; }
cls () { clear ; }
clh () { echo -n > ~/.zsh_history && history -p && exec zsh -l; }
clha () { echo -n > ~/.zsh_history && history -p && rm -f ~/.bash_history; rm -f ~/.node_repl_history; rm -f ~/.python_history; exec zsh -l; }
...
if [ -d $HOME/Library/CloudStorage/Dropbox ]; then
    dropbox () { cd $HOME/Library/CloudStorage/Dropbox ;}
fi
ip () { command ipconfig "$@" ; }
...
p () {
    if [ $# -eq 0 ]; then
        ...
        if [[ $1 =~ '^[0-9]+$' ]]; then
            ...
            cd ~/Downloads ;
        elif [[ $1 == lb ]] || [[ $1 == lib ]] || [[ $1 == Lib ]]; then
            cd ~/Library ;
        elif [[ $1 == mv ]] || [[ $1 == mov ]] || [[ $1 == Mov ]]; then
            cd ~/Movies ;
        elif [[ $1 == ms ]] || [[ $1 == mus ]] || [[ $1 == Mus ]]; then
            cd ~/Music ;
        elif [[ $1 == pc ]] || [[ $1 == pic ]] || [[ $1 == Pic ]]; then
            cd ~/Pictures ;
        elif [[ $1 == ic ]] || [[ $1 == icl ]] || [[ $1 == iCl ]] || [[ $1 == cl ]] || [[ $1 == clo ]] || [[ $1 == Clo ]] ; then
            cd $HOME/Library/Mobile Documents/com~apple~CloudDocs ;
        elif [[ $1 == dr ]] || [[ $1 == dro ]] || [[ $1 == Dro ]] || [[ $1 == drp ]] || [[ $1 == Drp ]] ; then
            if [ -d $HOME/Library/CloudStorage/Dropbox ]; then
                cd $HOME/Library/CloudStorage/Dropbox ;
            else
...
chicn () {
    if [ $# -eq 2 ]; then
        ...
        if ! [ -f $1 ]; then
            echo "chicn: cannot stat '$1': No such file"
        elif ! [ -d $2 ]; then
            echo "chicn: cannot stat '$2': No such directory"
        else
            sudo rm -rf "$2"$'/Icon\r'
            sips -i "$1" > /dev/null
