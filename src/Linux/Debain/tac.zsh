...
#alias rpm='sudo rpm' # Red Hat Package Manager for RHEL-based
#alias dnf='sudo dnf' # Dandified YUM for RHEL-based
#alias yum='sudo yum' # Yellowdog Updater, Modified (old) for RHEL-based
#alias zypper='sudo zypper' # Zen / YaST Packages Patches Patterns Products for SUSE-based
#alias pacman='sudo pacman' # Pacman for arch-based family
#alias emerge='sudo emerge' # Portage for gentoo-based
